        ...
        return (
            <div key={i} className='log_day'>
                ...
                <div className='check-box-parent'>
                    <input onClick={()=>{ this.check(i)}} type="checkbox" id={i} defaultChecked={logSeven[i]}/>
...
//         console.log('provide last seven days func fired')
